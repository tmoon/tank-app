...
export default class Account3 extends Component {
  render () {
    return (
      <View style={{ flex: 1,  marginTop: 30, marginBottom: 500 }}>
        <View style={{ flex: 1, marginLeft: 20, justifyContent: "flex-start" }}>
          <Text style={{fontSize: 30, fontWeight: "700"}}>Account Created!</Text>
